...
cover: 'https://mellaza.tech/img/cover-img/ascii-engine/sna-cover.jpg'
...
![|inline](img/ascii-engine/memory.png)
...
![|inline](img/ascii-engine/fight.png)
...
![|inline](img/ascii-engine/degrade.png)
...
|:---:|:---:|
| ![|inline](img/ascii-engine/image.png) | ![|inline](img/ascii-engine/image-1-ascii.png) |
| ![|inline](img/ascii-engine/image-2.png) | ![|inline](img/ascii-engine/image-2-ascii.png) |
...
![|inline](img/ascii-engine/raycasting-1.png)
...
![|inline](img/ascii-engine/raycasting-2.png)
...
![|inline](img/ascii-engine/raycasting-3.png)
...
![|inline](img/ascii-engine/raycasting-6.png)
...
|:---:|:---:|:---:|
|**positif**| **positif** | ![|inline](img/ascii-engine/raycasting-7.png) |
|**positif**| **négatif** | ![|inline](img/ascii-engine/raycasting-8.png) |
|**négatif**| **positif** | ![|inline](img/ascii-engine/raycasting-10.png) |
|**négatif**| **négatif** | ![|inline](img/ascii-engine/raycasting-9.png) |
...
![|inline](img/ascii-engine/raycasting-11.png)
![|inline](img/ascii-engine/raycasting-12.png)
![|inline](img/ascii-engine/raycasting-13.png)
...
![|inline](img/ascii-engine/raycasting-14.png)
...
![|inline](img/ascii-engine/raycasting-15.png)
...
![|inline](img/ascii-engine/raycasting-16.png)
...
![|inline](img/ascii-engine/raycasting-17.png)
...
![|inline](img/ascii-engine/raycasting-18.png)
...
![|inline](img/ascii-engine/Effet_fisheye.jpg)
![|inline](img/ascii-engine/raycasting-20.png)
![|inline](img/ascii-engine/raycasting-19.png)
